...
[![GitHub commits since tagged version](https://img.shields.io/github/commits-since/kevinzg/facebook-scraper/v0.2.57)](https://github.com/kevinzg/facebook-scraper/commits/)
...
```sh
pip install git+https://github.com/leftas/facebook-scraper.git
```
